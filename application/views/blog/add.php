            ...
            <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto">
                        <a href="" class="nav-item nav-link active">Product Detail</a>
    ...
    <div class="breadcrumb-wrap">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url("index.php")?>">Products</a></li>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                <div class="product-slider-single normal-slider">
                                    <img src="<?php echo base_url('dist/img/' . $obj_produk->foto) ?>" alt="Product Image')?>">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <?php $hidden = ['id_produk' => $obj_produk->id]; ?>
                                <?php echo form_open("blog/add","",$hidden) ?>
                                <div class="product-content">
                                    <div class="title">
                                        <h2 name="nama"><?php echo $obj_produk->nama ?></h2>
                                    </div>
                                    <div class="ratting">
                                    ...
                                    <div class="price">
                                        <h4>Price:</h4>
                                        <p><?php echo $obj_produk->harga_jual - $obj_produk->harga_jual * 10 / 100 ?> <span><?php echo $obj_produk->harga_jual ?></span></p>
                                    </div>
                                    <div class="quantity">
                                        <h4>Quantity:</h4>
                                        <div class="qty">
                                    ...
                                    <div class="action">
                                        <button class="btn" type="submit" href=""><i class="fa fa-shopping-bag"></i>Buy Now</a>
                                    </div>
                                </div>
                                <?php echo form_close() ?>
                            </div>
